    ...
    <div className="settings-pane">
      <div className="settings-scroll">
        ...
        <section className="settings-section">
          ...
          <InfoRow label="Dataset" value="medbill_v1 (FY 2026)" />
          <InfoRow label="Place of Service" value="50" />
          <InfoRow label="HCPCS modifiers" value="47" />
          <InfoRow label="MS-DRGs" value="770 (all w/ FY 2026 weights)" />
          <InfoRow label="MDC categories" value="26" />
          <InfoRow label="CC / MCC ICD codes" value="18,432" />
          <InfoRow label="ICD → DRG routings" value="213,321" />
          <InfoRow label="Source" value="CMS Definitions Manual v43.0 + IPPS FY 2026 Table 5 (public domain)" />
          <InfoRow label="Refresh cadence" value="Semi-annual — Oct 1 / Apr 1" />
        </section>
        ...
        <section className="settings-section">
          ...
          <p className="settings-disclaimer">
            MedBill Snap is a reference tool. Always verify codes and DRG
            routings against official CMS sources and the IPPS Grouper before
            billing. No data leaves your computer except license activation.
            AMA CPT codes are not included — only the CMS public-domain
            portions (POS, HCPCS Level II alpha-numeric modifiers, MS-DRG
            definitions, CC/MCC tables).
          </p>
        </section>
      </div>
    </div>
